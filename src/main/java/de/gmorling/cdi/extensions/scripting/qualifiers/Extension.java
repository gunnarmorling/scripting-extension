...
/**
 * Specifies the extension of a <a
...
public @interface Extension {
	...
	/**
	 * The extension of a <a href="http://jcp.org/en/jsr/detail?id=223">JSR
	 * 223</a> ("Scripting for the Java<sup>TM</sup> Platform") scripting engine
	 * as expected by {@link ScriptEngineManager#getEngineByExtension(String)}.
	 * 
	 * @return A JSR 223 scripting language extension.
	 */
	@Nonbinding
	String value();
