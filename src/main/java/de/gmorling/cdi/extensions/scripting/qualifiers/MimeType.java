...
/**
 * Specifies the MIME type of a <a
...
public @interface MimeType {
	...
	/**
	 * The MIME type of a <a href="http://jcp.org/en/jsr/detail?id=223">JSR
	 * 223</a> ("Scripting for the Java<sup>TM</sup> Platform") scripting engine
	 * as expected by {@link ScriptEngineManager#getEngineByMimeType(String)}.
	 * 
	 * @return A JSR 223 scripting language MIME type.
	 */
	@Nonbinding
	String value();
